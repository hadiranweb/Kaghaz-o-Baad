...
'Kaghaz-o-Baad (Paper and Wind) is a bilingual EN/FA academic publishing platform. Paper symbolizes data; Wind symbolizes the living environment carrying it. The app hosts long-form scholarly articles with two reading modes: traditional text and an interactive slide-based experience.',
