...
import { ProgressDock } from '@/components/creative/ProgressDock';
import { aboutProgressItems, useActiveSection } from '@/components/creative/aboutProgressData';
...
export default function AboutProject() {
  ...
  const activeSection = useActiveSection(aboutProgressItems);
  ...
  return (
    <main dir={dir} className="min-h-screen pb-16 bg-background">
      ...
      <div className="container mx-auto max-w-6xl px-4 pt-8 lg:px-8">
        <div className="hidden lg:block">
          <ProgressDock items={aboutProgressItems} locale={locale} activeId={activeSection} />
        </div>
        <div className="lg:hidden">
          <ProgressDock items={aboutProgressItems} locale={locale} activeId={activeSection} compact />
        </div>
      </div>
