...
import { Shield, Trash2, Eye, Save, Plus } from 'lucide-react';
      ...
      <div className="flex items-center gap-3 mb-8">
        ...
        <div>
          <h1 className="text-3xl font-bold">
            {locale === 'fa' ? 'داشبورد مدیریت ادمین' : 'Admin Dashboard'}
          </h1>
          <p className="text-muted-foreground mt-1">
            {locale === 'fa' ? 'مدیریت کل سایت و مقالات' : 'Manage entire site and articles'}
          </p>
        </div>
      </div>
        ...
        <Tabs defaultValue="articles" className="w-full">
          <TabsList className="mb-4">
            ...
            <TabsTrigger value="live">
              {locale === 'fa' ? 'پخش‌های زنده' : 'Live Sessions'}
            </TabsTrigger>
          </TabsList>
